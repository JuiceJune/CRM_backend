                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('admin.positions.show', $position->id) }}">{{ $position->title }}</a></li>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title"
                                       placeholder="Enter Position" name="title" value="{{$position->title}}">
                                @error('title')
