...
class LinkedinController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->isAdmin()) {
            ...
            $linkedin_accounts = $user->projects()->with('linkedin_accounts')->get()->pluck('linkedin_accounts')->flatten();
        }
        return response()->json(LinkedinResource::collection($linkedin_accounts));
    }
    ...
    {
        return new LinkedinResource($linkedin);
    }
