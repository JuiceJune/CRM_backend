...
class ClientStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'max:100', new UniquePerAccount('clients', 'name', $this->user()->account_id)],
            'email' => ['nullable', 'string', 'email', 'max:100', new UniquePerAccount('clients', 'email', $this->user()->account_id)],
            'avatar' => 'image',
        ];
    }
